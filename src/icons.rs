...
mod tests {
    ...
    fn test_build_asset_path_normalizes_windows_separators() {
        let path = build_asset_path("assets\\icons\\mrbreakfast\\png", "xbox_a.png");
        assert_eq!(path, "assets/icons/mrbreakfast/png/xbox_a.png");
    }

    #[test]
    fn test_build_asset_path_trims_extra_separators() {
        let path = build_asset_path("assets/icons/", "/xbox_a.png");
        assert_eq!(path, "assets/icons/xbox_a.png");
    }
}
