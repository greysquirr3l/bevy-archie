...
- Fixed controller icon asset path handling on Windows in `src/icons.rs`.
  - Thanks to @andyleclair for reporting the issue and opening PR #23.

### Changed

- Hardened CI/release/security workflows with pinned actions, concurrency controls,
  Windows and macOS compatibility gates, and release-chain safeguards.
